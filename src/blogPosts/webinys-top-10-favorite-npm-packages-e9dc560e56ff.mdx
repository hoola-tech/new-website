...
title: "Hoola AI’s Top 10 Favorite NPM Packages"
description: "At Hoola AI we do have the package-of-the-day slack channel where we post our favorite NPM packages daily 🙃"
tags:
  ["Javascript", "Nodejs", "Serverless", "Open source", "Web development", "Software development"]
featureImage: "./assets/webinys-top-10-favorite-npm-packages-e9dc560e56ff/max-3840-1epGtKm7B1cAzl1DR8YngsQ.png"
author: albiona
date: 2020-09-21
---

At Hoola AI we do have the `package-of-the-day` slack channel where we post our favorite NPM packages daily 🙃
