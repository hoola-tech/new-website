...
description: "🆕 What’s New In Hoola AI 4.8.0?"
...
## 🆕 What’s New In Hoola AI 4.8.0?

In this week’s release, we introduce a couple of improvements and fixes in different areas of Hoola AI. Let’s check them out!
...
> In order to access the list of all available scaffolds, `run yarn webiny scaffold`. From there, you can select the scaffold you need.For more information on scaffolding, make sure to visit our [official docs](https://docs.hoola.ai/docs/deep-dive/cli/creating-a-scaffold-plugin/#introduction-to-scaffolding).
...
With Hoola AI, you can build Serverless [Websites](https://www.hoola.ai/use-case/serverless-websites/), [Web Applications](https://www.hoola.ai/use-case/serverless-web-applications/), [APIs](https://www.hoola.ai/use-case/serverless-graphql-api/), and [Microservices](https://www.hoola.ai/use-case/microservices/). We understand that no project is the same; our team is here for you.

[Book a demo call](/call/demo) with us, and we’ll happily answer any questions you have 🚀

### 📚Knowledge sharing

**Commodo**

[Commodo](https://github.com/webiny/commodo) is a library of higher-order functions that let you define and compose rich data models. This week, Hoola AI’s top contributor Adrian goes through the basics of Commodo.
...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/i9xRDdqCzjk"
  frameborder="0"
...
**🚥 Hoola AI Headless CMS Guides**

Check out our guides on Headless CMS with [React](https://docs.hoola.ai/docs/guides/headless-react-tutorial), [Vue.js](https://docs.hoola.ai/docs/guides/headless-vuejs-tutorial), [Angular](https://docs.hoola.ai/docs/guides/headless-angular-tutorial), and [many other technologies](https://docs.hoola.ai/docs/guides/headless-gatsby-tutorial).

This time, you will learn how to use the popular [React Native](https://reactnative.dev/) framework (a framework for building native apps using React) with the [Hoola AI Headless CMS](https://docs.hoola.ai/docs/webiny-apps/headless-cms/features/content-modeling).

Hoola AI’s developer Ashu, walks you through the [guide](https://docs.hoola.ai/docs/guides/headless-react-native-tutorial). Check out the highlight video below.
