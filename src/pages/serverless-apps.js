...
const WebinyAppsPage = () => {
    ...
    return (
        <BaseLayout
            title="Open-source serverless applications"
            description="Hoola AI is an open-source framework for building serverless applications. Hoola AI is powered by React, Node and GraphQL."
            fixedHeader={false}
        >
            <WebinyApps />
            <GoServerless />
