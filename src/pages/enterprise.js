...
const metaDescription =
    "Hoola AI provides organisations with the technology, processes, knowledge and support to successfully build and deliver solutions on top of serverless infrastructure.";
