    ...
    render() {
        return (
            <section {...this.props} className={wrapperClass}>
                <SubTitle>Hoola AI Comes With Several Ready-Made Serverless Apps</SubTitle>
                ...
                <ContentContainer>
                    ...
                    >
                        <div>
                            <img src={headlessCms} alt="Hoola AI Serverless Headless CMS" />
                        </div>
                        <div>
                            <img src={pageBuilder} alt="Hoola AI Serverless Page Builder" />
                        </div>
                        <div>
                            <img src={formBuilder} alt="Hoola AI Serverless Form Builder" />
                        </div>
                        <div>
                            <img src={fileManager} alt="Hoola AI Serverless File Manager" />
                        </div>
                    </Slider>
                    <Slider
