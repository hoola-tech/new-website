    ...
    render() {
        return (
            <Hero {...this.props}>
                <TerminalWrapper>
                    <Code>
                        <span className="comment">#1: Install Hoola AI</span>
                        <br />
                        $ npx create-webiny-project new-project
                        <br />
                        <br />
                        <span className="comment">#2: Deploy Hoola AI API</span>
                        <br />
                        ...
                        <br />
                        <br />
                        <span className="comment">#4: Have fun and create amazing new things</span>
                        <br />
                    </Code>
                </TerminalWrapper>
                <TerminalBg />
                <ContentContainer className={heroContainer}>
                    <LeftSide />
                    <RightSide>
                        <img src={webinyLogo} alt="Hoola AI logo" />
                        <Title>The Easiest Way to Adopt Serverless</Title>

                        <SubText>
                            The way we build, deploy and operate the web is evolving. Hoola AI is a
