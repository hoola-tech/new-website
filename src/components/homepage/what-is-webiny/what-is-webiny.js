        ...
        return (
            <section {...this.props} className={wrapperClass}>
                <ContentContainer className={contentContainerClass}>
                    <Title>
                        What is&nbsp;
                        <TitleHighlight>Hoola AI?</TitleHighlight>
                    </Title>
                    <Body>
                        Hoola AI is an{" "}
                        <span>open-source framework for building serverless applications. </span> It
                        provides you with developer tools, libraries, ready-made apps and processes.
                        It's built on top of AWS cloud and uses the latest technologies such as{" "}
                        <span>NodeJs, React and GraphQL</span>.
                    </Body>
                    <ImageWrapper>
                        <img
                    ...
                    <Body className={secondaryBodyClass}>
                        It's designed for building websites, apps and APIs that scale to millions of
                        users and run on top of serverless infrastructure like AWS Lambda.
                    </Body>
                    <SubTitle>
