        ...
        return (
            <section {...this.props} className={wrapperClass}>
                <ContentContainer className={contentContainerClass}>
                    <SubTitle>
                        Serverless makes infrastructure easy, Hoola AI makes{" "}
                    ...
                    <Wrapper>
                        <ReasonBox>
                            ...
                            <p className="text">
                                Hoola AI has been made with the developer in mind. It helps them
                                develop serverless applications with ease.
                            </p>
                        </ReasonBox>
                        <ReasonBox>
                            ...
                            <p className="text">
                                Hoola AI is created and maintained by an amazing group of people.
                                Being open source means Hoola AI grows and evolves much faster.&nbsp;
                                <a
                                    onClick={() => {
                        ...
                        <ReasonBox>
                            ...
                            <p className="text">
                                ...
                                . Talk to the core-team, and get help. Hoola AI team is always there
                                for any questions.
                            </p>
                        </ReasonBox>
                    </Wrapper>
