        ...
        return (
            <section {...this.props} className={wrapperClass}>
                <ContentContainer className={contentContainerClass}>
                    <CardsWrapper>
                        <Card className={serverlessCardClass}>
                            ...
                            <Content>
                                <Title>
                                    Why{" "}
                                    <TitleHighlight imgUrl={bgServerless}>
                                        Serverless?
                                    </TitleHighlight>
                                </Title>
                                <Body>
                                    Reduces the cost of infrastructure by 60-80%, however it also
                                    comes with many hidden challenges.
                                </Body>
                            </Content>
                        </Card>
                        ...
                        <Card className={webinyClass}>
                            <Content>
                                <Title>
                                    Why <TitleHighlight imgUrl={bgWebiny}>Hoola AI?</TitleHighlight>
                                </Title>
                                <Body>
                                    Get around serverless challenges and save over $300k in
                                    development costs.
                                </Body>
                            </Content>
                    ...
                    <ButtonWrapper>
                        <Button className={ctaButton} type={"secondary"} link={"why-webiny"}>
                            Learn more about serverless & how Hoola AI can help
                        </Button>
                    </ButtonWrapper>
                </ContentContainer>
            </section>
