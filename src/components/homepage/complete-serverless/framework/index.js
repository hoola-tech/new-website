...
const navigationContent = [
    {
        ...
        description:
            "There are many solutions that help you run, deploy and monitor serverless functions, but when it comes to actually coding one, there are none. Hoola AI is a solution that helps you code your serverless app by providing you with all the components like ACL, routing, file storage and many more, specifically created for serverless environments.",
        subtitle: "Build with Hoola AI Framework:",
    ...
    },
    {
        ...
        description:
            "We understand that most projects have a strong preference on the type of the database. For this reason Hoola AI comes with multi-database support out of the box. In case your preferred database is not on the list - it's easy to build an adapter for one.",
        relatedList: [
            "DynamoDB support",
    ...
    },
    {
        ...
        description:
            "Hoola AI being serverless reduces potential attack vectors for attackers. Hoola AI also can be deployed inside a VPC with a whitelisted access control, giving you even greater security over your data and how users can access your application.",
        relatedList: [
    ...
    },
    {
        ...
        description:
            "Hoola AI is built using many of the tools you already know and use today. In case you need to bring in any other tools or libraries, just import them like any other NPM package.",
        relatedList: [
        ...
        <FrameworksSection>
            <Navigation>
                <div className="navigation-header">
                    <img src={Logo} alt="" />
                    <h5>
                        Hoola AI Serverless <span> Application Framework</span>
                    </h5>
                </div>
