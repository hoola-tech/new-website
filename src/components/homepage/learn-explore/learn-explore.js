    ...
    render() {
        return (
            <section {...this.props} className={wrapperClass}>
                <SubTitle>Go Serverless With Hoola AI</SubTitle>
                ...
                <ContentContainer>
                    <Grid>
                        <Cell>
                            ...
                            <p>
                                Get started tutorial will guide you step by step. From installing a
                                local dev environment to deploying a website.
                                <br />
                                <br />
                                <br />
                            </p>
                        ...
                        <Cell>
                            ...
                            <h4>Explore</h4>
                            <h3>
                                Get to know Hoola AI, its features and what you can build using it
                            </h3>
                            <p>
                                Hoola AI is a powerful tool that allows you to build more than just
                        ...
                        <Cell>
                            <img src={imgCommunity} alt="Community" />
                            <h4>Join</h4>
                            ...
                            <p>
                                ...
                                other have the best possible time with Hoola AI. The core Hoola AI team
                                is also there and it’s the best place to share your feedback.
                            </p>
                            <Button
                                className={ctaButton}
                                link="https://www.hoola.ai/slack"
                                type="dark"
                            >
                                Community Chat
                            </Button>
