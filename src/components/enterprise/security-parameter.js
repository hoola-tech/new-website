    ...
    return (
        <section className={wrapperClass}>
            <ContentContainer>
                <Wrapper>
                    <Title>
                        Hoola AI security <TitleHighlight>perimeter</TitleHighlight>
                    </Title>
                </Wrapper>
            </ContentContainer>
            <ContentContainer className={contentContainerClass}>
                <Feature>
                    <FeatureInfo>
                        ...
                        <FeatureDescription>
                            Hoola AI is hosted inside your own AWS cloud. You own all the networking,
                            security and databases. Hoola AI doesn't break your data regulation
                    ...
                    <Feature className="reverse">
                        <FeatureInfo>
                            ...
                            <FeatureDescription>
                                ...
                                Hoola AI instance to be. Hoola AI can be deployed both inside a VPC, as
                                well as outside.
                            </FeatureDescription>
                            <FeatureDescription>
            ...
            <ContentContainer className={contentContainerClass}>
                <Feature>
                    <FeatureInfo>
                        ...
                        <FeatureDescription>
                            Hoola AI, being a public open-source project, our code is our product. But
                ...
                <ContentContainer className={contentContainerClass}>
                    <Feature className="reverse">
                        <FeatureInfo>
                            ...
                            <FeatureDescription>
                                Hoola AI deployment mechanism is completely customisable. By default
                                Hoola AI uses Pulumi, however, you can change this and integrate
                ...
                <Feature>
                    <FeatureInfo>
                        ...
                        <FeatureDescription>
                            ...
                            ensure your team uses serverless and Hoola AI best practices.
                        </FeatureDescription>
                        <FeatureDescription>
