...
const FeatureInfo = styled("div")(
    ...
    mq({
        ...
        "&.border-right": {
            borderRight: ["none", "2px dashed #374E94"],
        },

        "&.border-left": {
            borderLeft: ["none", "2px dashed #374E94"],
        },
    }),
);
                ...
                {OUR_PARTNERS_DATA.sort(sortAlphabetically).map((partner, index) => (
                    <Feature key={index}>
                        ...
                        <FeatureInfo className={index % 2 ? "border-right" : "border-left"}>
                            ...
                            <ButtonGroup>
                                <Button type="primary" link={"mailto:partners@hoola.ai"}>
