...
const partnerList = [
    ...
    { image: insightImg, title: "Insight into Hoola AI roadmap" },
    { image: clientImg, title: "Client introductions" },
    { image: commissionImg, title: "Commission on Hoola AI Enterprise sales" },
];
    ...
    return (
        <Section>
            <ContentContainer className={containerClass}>
                <Wrapper>
                    <Title>
                        Want to become a <TitleHighlight>Hoola AI partner?</TitleHighlight>
                    </Title>
                    <p>Being a Hoola AI partner comes with many benefits.</p>
