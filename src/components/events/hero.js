...
const Hero = () => (
    <React.Fragment>
        <Header bg={headerBg} className={heroStyle}>
            <Title>Hoola AI Online Meetups</Title>
            <Subtitle>
                Attend our online knowledge-sharing sessions every Thursday. We are creating a
                knowledge database so our community members get involved in Hoola AI
            </Subtitle>
        </Header>
    </React.Fragment>
);
