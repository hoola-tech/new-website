    ...
    render() {
        return (
            <section {...this.props} className={wrapperClass}>
                <SubTitle>Hoola AI Online Knowledge-Sharing (KS) Sessions</SubTitle>
              ...
              <img src={tobeContinued} alt="To be Continued - Knowledge Sharing Session" />
                    ...
                    >
                        <div className="content">
                            ...
                            <h4>KS Session 1</h4>
                            <p>
                                In this session we'll explain how Hoola AI works so you can
                        ...
                        <div className="content">
                            ...
                            <h4>Prerequisites</h4>
                            <p>
                                This is a quick start guide that should help you setup Hoola AI as
                                fast as possible.
                            </p>
                            <Button
                                className={ctaButton}
