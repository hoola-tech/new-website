    ...
    render() {
        ...
        return (
            <section {...this.props} className={wrapperClass}>
                <SubTitle>Attend Hoola AI Online Meetups</SubTitle>
                <SubTitleText>
                    Build Websites, Apps and APIs With Hoola AI
                    <br />
                    Join our Hoola AI Community and share your ideas
                </SubTitleText>

                <FeatureList></FeatureList>
                <ButtonWrapper>
                    <FreeDemoImage src={freeArrowIcon} />
                    <Button onClick={handleTalkClick} className={ctaButton} type="secondary">
