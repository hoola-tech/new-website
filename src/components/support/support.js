...
export default ({ children, ...props }) => (
    <React.Fragment>
        <Hero {...props}>
            <ContentContainer>
                <Title>Support</Title>
                <SubText>Need some help? Explore the options below.</SubText>
            </ContentContainer>
        </Hero>
            ...
            <Grid>
                <Cell>
                    ...
                    <p>
                        ...
                        Exploring the docs is the best way to learn how to use Hoola AI.
                    </p>
                </Cell>
                <Cell>
                    <h3>
                    ...
                    <p>
                        Something broke or not working properly? Have a look at the current issues
                        on our GitHub, or report an new one.
                    </p>
                </Cell>
                <Cell>
                    <PremiumBox>
                        ...
                        <p>
                            Talk directly to the people that built Hoola AI. Get your problem resolved
                            quickly.
                            <br />
                            <a href="mailto:sven@hoola.ai">
            ...
            <Grid>
                <Cell>
                    <h3>
                        ...
                        <a href="https://community.hoola.ai/">
                            Community
                            <img className={"arrow"} src={arrow} alt="" />
                        </a>
                    </h3>
                    <p>
                        Join the Hoola AI Community and get access to many smart people. You’ll find a
                        lot of valuable information and get the opportunity to ask fellow members
                        questions.
                    </p>
                </Cell>
                <Cell>
                    <h3>
                        ...
                        <a href="https://blog.hoola.ai/">
                            Blog
                            <img className={"arrow"} src={arrow} alt="" />
                        </a>
                    </h3>
                    <p>
                        We blog often about Hoola AI and its capabilities, features and several other
                        technical topics. It’s a good place to explore.
                    </p>
                </Cell>
                <Cell />
            </Grid>
