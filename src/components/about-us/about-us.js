    ...
    <Fragment>
        ...
        <Section>
            <ContentContainer className={welcomeContainerClass}>
                ...
                <WelcomeText>
                    At Hoola AI we have a mission to empower every developer to create serverless
        ...
        <Section>
            <ContentContainer className={welcomeContainerClass}>
                ...
                <StoryText>
                    Many moons ago, Hoola AI was just another digital agency. We were building
                ...
                <StoryText>
                    ...
                    a community. A community of developers that we could support with Hoola AI and
                    that would join us on our mission, and help us achieve our goals. As a result,
                    we have released Hoola AI under the MIT open-source licence so everyone can use it
        ...
        <SectionWithGrayRectangle>
            <ContentContainer className={contributorsContainerClass}>
                <ContributorsText>
                    Assisted by our <span>Hoola AI community</span> and <span>contributors</span>
                </ContributorsText>
                <ContributorsWrapper>
                    <Contributors />
                </ContributorsWrapper>
        ...
        <Section>
            <ContentContainer className={welcomeContainerClass}>
                ...
                <ButtonWrapper>
                    <Button type={"dark"} link={"https://careers.hoola.ai/"}>
