...
const tilesData = [
    {
        ...
        description: (
            <>
                Hoola AI runs<OrangeText> inside your own AWS cloud.</OrangeText> Your data, under
                your own rules.
            </>
        ),
    },
...
const ModernBusinesses = () => {
    return (
        <ModernTechSolutions
            ...
            subtitle="We have created Hoola AI CMS to provide solutions to these problems and support the web products of the future."
        />
    );
};
