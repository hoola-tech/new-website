...
export const mainTitle = (
    <>
        <span>Here is how Hoola AI stands out</span> from other competitive CMS solutions
    </>
);
        ...
        webiny: {
            text: (
                <div className="text-center">
                    ...
                    <a
                        style={{ color: "#00CCB0" }}
                        href="https://www.hoola.ai/docs/performance-and-load-benchmark/introduction"
                    >
                        (Read more)
                    </a>
                </div>
...
export const cmsNames = ["Hoola AI", "Contentful", "Strapi", "Storyblok", "Sanity", "Webflow"];
