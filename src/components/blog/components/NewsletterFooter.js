        ...
        return (
            <Section>
                <ContentContainer className={containerClass}>
                    <WebinyAppsWrapper>
                        <Wrapper>
                            <h4>About Hoola AI</h4>
                            <p>
                                Hoola AI is an open source serverless CMS that offers you all the
                        ...
                        <Wrapper>
                            <h4>Newsletter</h4>
                            <p>
                                Want to get more great articles like this one in your inbox. We only
                                send one newsletter a week, don't spam, nor share your data with 3rd
                                parties.
                            </p>
                            <div className={"button"}>
                                <Button
                                    type="dark"
                                    target="_blank"
                                    link={"https://landing.mailerlite.com/webforms/landing/g9f1i1"}
                                >
                                    Subscribe
                                </Button>
                            </div>
