...
const buildList = [
    ...
    },
    {
        ...
        title: "Microservices",
        description:
            "One service, or a whole fleet. Hoola AI provides you with project organization, code bundling, IaC and deployment mechanisms ready to go.",
    },
    {
        img: Build5,
    ...
    return (
        <BuildFrameworkSection>
            <ContentContainer className={ContainerClass}>
                <Title>
                    Build with Hoola AI Serverless Application &nbsp;
                    <TitleHighlight>Framework</TitleHighlight>
                </Title>
                <Description>
                    From small and simple projects, to large and complex ones, you'll have it
                    covered.
                </Description>
                <BuildList>
