...
export const FEATURES = [
    ...
    },
    {
        ...
        body:
            "Using Hoola AI CLI each app takes a single command to create and configure all of its serverless services.",
...
export const APPS = [
    {
        ...
        imgAlt: "Hoola AI headless cms app",
    ...
    },
    {
        ...
        imgAlt: "Hoola AI page builder app",
        actionLabel: "learn more",
    ...
    },
    {
        ...
        imgAlt: "Hoola AI form builder app",
        actionLabel: "learn more",
    ...
    },
    {
        ...
        imgAlt: "Hoola AI file manager app",
        actionLabel: "learn more",
