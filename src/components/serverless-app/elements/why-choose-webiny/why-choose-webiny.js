    ...
    <Fragment>
        <section {...props} className={sectionClass}>
            <ContentContainer className={contentContainerClass}>
                <TextWrapper>
                    <Title>
                        Why choose<TitleHighlight> Hoola AI</TitleHighlight>?
                    </Title>
                </TextWrapper>
            </ContentContainer>
        </section>
        <section {...props} className={wrapperClass}>
            <ContentContainer className={contentContainerClass}>
                <ComparisonWrapper>
                    <BoxWrapper>
                    ...
                    <BoxWrapper>
                        ...
                        <Box>
                            ...
                            <ul>
                                ...
                                <li>
                                    <DotImage src={uncheckMark} alt="point" />
                                    Need to over provision and over pay for infrastructure to handle
                                    peak demands
                                </li>
                                <li>
                                    <DotImage src={uncheckMark} alt="point" />
                                    Worry about flash-crowds, networking, orchestration,
                    ...
                    <BoxWrapper>
                        ...
                        <Box>
                            <ProductTitle>Hoola AI</ProductTitle>
                            <ul>
                                <li>
                                    <CheckMarkImg src={checkMark} alt="check mark" />
                                    Serverless level scale, handle any peak demand right out of the
                                    box
                                </li>
                                <li>
                                    <CheckMarkImg src={checkMark} alt="check mark" />
                                ...
                                <li>
                                    <CheckMarkImg src={checkMark} alt="check mark" />
                                    Faster time to market as you don't spend time on architecting
