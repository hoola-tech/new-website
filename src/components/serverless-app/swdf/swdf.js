        ...
        <Hero
            ...
            media={
                <img
                    ...
                    src={HeroImage}
                    alt="Hoola AI Serverless Web Development Framework"
                />
            }
        >
            <List>
...
https://xyz.amazonaws.com/`}
                ...
                <Grid right>
                    <Cell title="Hoola AI CLI">
                        <p>
                            Hoola AI CLI is the tool that you will use to build, watch and deploy your
                            serverless applications.
                        </p>
                        <p>
...
webiny run <command> [options]         Run command defined in
                                       ...
                                       webiny.config.js)
webiny enable-tracking                 Enable tracking of Hoola AI stats.
webiny disable-tracking                Disable tracking of Hoola AI stats.
...
webiny remove api --env=dev`}
                ...
                <Grid right>
                    <Cell title="Powered by plugins">
                        <p>
                            From the ground up, Hoola AI is built on top of plugins, which are
  ...
  somethingNested: {
    ...
    getANewDate: () => new Date()
                ...
                <Grid right>
                    <Cell title="Routes">
                        <p>
                            Every single-page application consists of routes, and Hoola AI is no
                ...
                <Grid right>
                    <Cell title="Menus">
                        <p>
                            ...
                            But don't worry, Hoola AI's got you covered here as well! With "menu"
        ...
        <Section label={"Customers"}>
          ...
          <Item label={"Discounts"} path="/my-app/customers/discounts" />
                ...
                <Grid right>
                    <Cell title="GraphQL">
                        <p>
                            All Hoola AI apps are powered by a GraphQL HTTP API which can be easily
        ...
        resolvers: {
            ...
            MyAppMutation: {
                ...
                <Grid right>
                    <Cell title="Models">
                        <p>
                            For all database-related tasks, Hoola AI relies on the Commodo library,
