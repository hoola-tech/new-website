...
const FirstBlocks = () => (
    <ContentContainer>
        <Grid>
            <Cell>
                <img className={"image-small"} src={imgCommunityTools} alt="imgCommunityTools" />
                <h4>Made for Developers</h4>
                <h3>
                    We created Hoola AI with developers in mind. It's a single platform built with
                    community accepted tools and libraries.
                    <br />
                    <br />
                </h3>
            </Cell>
            <Cell>
                ...
                <h3>
                    Hoola AI is built as a set of microservices using serverless technologies.
                    Infinitive scale, zero maintenance.
                    <br />
                    <br />
                </h3>
            </Cell>
            <Cell>
                ...
                <h3>
                    Hoola AI is open-source which allows you to modify, extend and adapt the system so
                    it exactly fits your needs.
                </h3>
            </Cell>
        </Grid>
    </ContentContainer>
    ...
    <ContentContainer>
        <Grid>
            <Cell>
                ...
                <h3>
                    The beauty of using a headless CMS is that your content becomes device and
                    channel agnostic.
                    <br />
                    <br />
                </h3>
            ...
            <Cell>
                ...
                <h3>
                    No need to make any tradeoffs between using a scaleable SaaS solution, or using
                    a customizable open-source solution. Hoola AI is best of both.
                    <br />
                    <br />
                </h3>
            </Cell>
