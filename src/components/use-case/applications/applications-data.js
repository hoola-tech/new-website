...
export const FEATURES = [
    ...
    },
    {
        ...
        renderBody: () => (
            <Fragment>
                <p>
                    With a simple command install Hoola AI locally on your machine. Develop using
    ...
    },
    {
        ...
        renderBody: () => (
            <Fragment>
                <p>
                    One language is all you need to know to build on top of Hoola AI. React on the
