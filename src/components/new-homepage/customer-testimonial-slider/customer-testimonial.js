    ...
    const sliderItems = [
        {
            ...
            description:
                "We've been very happy with our experiences using Hoola AI. The documentation is clear and concise, and the community is quick to help out which has made for a pleasant developer experience.",
        },
        {
            name: "Serge Morel",
        ...
        },
        {
            ...
            description:
                "If someone is looking for a Modern Web framework with React, Serverless, then Hoola AI should be the first and only choice. It has everything that we need from a modern development environment. In addition, Dev experience is far beyond anything in my previous experience.",
        },
        {
            ...
            description:
                "We are using Hoola AI for ourselves as well as for some of our major clients. So far, we are loving it and getting good feedback from our clients. Hoola AI is exactly what I want a CMS to be. It is free, open-source, serverless, and cloud-native.",
        },
        {
            name: "Alexandru Iaru",
            ...
            description:
                "Hoola AI enabled us to quickly and intelligently craft a new Online Travel Agency website for our client.",
        },
        {
            name: "Alan Lam",
            ...
            description:
                "We really impressed by the features of Hoola AI which allow us to build a serverless CMS so quickly. The support from staff is so quick and direct, helping us a lot to solve problems. Very well experience working with Hoola AI.",
        },
        {
            ...
            description:
                "We were looking for a product that offered a scalable and performant CMS, and Hoola AI turned out to be a perfect choice. The CMS is really simple and intuitive, clearly documented and easy to use and customize. In addition to being a great product, it is constantly updated with the implementation of new features/improvements that the large community requests from the development team.",
        },
        {
            name: "James Hunter",
