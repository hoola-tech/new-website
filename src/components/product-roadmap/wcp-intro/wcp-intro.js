    ...
    return (
        <WCPIntroSection {...props}>
            <ContentContainer className={heroContainerClass}>
                <IntroWrapper>
                    <Title>
                        Introducing <TitleHighlight>Hoola AI Control Panel</TitleHighlight>
                    </Title>
                    <SubTitle>
                        At Hoola AI we have a mission to empower developers and organizations to build
                        serverless applications. As the next step in our mission, we want to bring
                        Hoola AI even closer to our audience. Hoola AI Control Panel will be our first
