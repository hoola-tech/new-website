...
export const TUTORIALS = [
    {
        ...
        title: "Get Started With Hoola AI",
        tags: ["YouTube", "Serverless"],
        // bannerText: "Official Tutorial",
        description:
            "This is a quick start guide that should help you setup Hoola AI as fast as possible.",
        link: "https://youtu.be/G_du-yE_DL4",
    },
    {
        id: 3,
        imgSrc: apiDev,
        imgAlt: "API Development With Hoola AI",
        authorImgSrc: Adrian,
        authorName: AUTHOR_NAMES.Adrian,
        title: "API Development With Hoola AI",
        tags: ["YouTube", "APIs"],
        description:
    ...
    },
    {
        ...
        description: "Learn how to use the popular React Native with the Hoola AI Headless CMS.",
        // bannerText: "Official tutorial",
        link: "http://docs.hoola.ai/docs/guides/headless-react-native-tutorial",
    },
    {
        id: 3,
        imgSrc: webinyPlugins,
        imgAlt: "Hoola AI Plugins",
        authorImgSrc: Pavel,
    ...
    },
    {
        ...
        imgAlt: "APP Development With Hoola AI",
        authorImgSrc: Pavel,
        authorName: AUTHOR_NAMES.Pavel,
        title: "APP Development With Hoola AI",
        tags: ["YouTube", "Apps"],
        description: "The mechanics of app development with Hoola AI",
        // bannerText: "Official tutorial",
    ...
    },
    {
        ...
        description: "Learn how to use Gatsby with the Hoola AI Headless CMS.",
        // bannerText: "Official tutorial",
        link: "http://docs.hoola.ai/docs/guides/headless-gatsby-tutorial",
    },
    {
        id: 1,
        ...
        authorImgSrc: Pavel,
        authorName: AUTHOR_NAMES.Pavel,
        title: "Hoola AI Deployment Mechanism",
    ...
    },
    {
        ...
        imgAlt: "Hoola AI Practical Plugins",
        authorImgSrc: Adrian,
        authorName: AUTHOR_NAMES.Adrian,
        title: "Hoola AI Plugins - Practical Examples",
    ...
    },
    {
        ...
        // bannerText: "Official tutorial",
        link: "http://docs.hoola.ai/docs/deep-dive/cli/creating-a-scaffold-plugin/",
    },
    {
        id: 3,
        ...
        // bannerText: "Official tutorial",
        link: "http://docs.hoola.ai/docs/guides/creating-iframe-element-plugin",
    },
    {
        id: 3,
        imgSrc: spaWebiny,
        imgAlt: "Single Page Applications with Hoola AI",
        authorImgSrc: Adrian,
        authorName: AUTHOR_NAMES.Adrian,
        title: "Single Page Applications with Hoola AI",
        tags: ["YouTube", "SPAs"],
        description: "Learn how Hoola AI enables us to create Single Page Applications (SPAs).",
        // bannerText: "Official tutorial",
    ...
    },
    {
        id: 3,
        imgSrc: reactStarter,
        imgAlt: "Build a Portfolio Website with React, Hoola AI, and Apollo",
        authorImgSrc: Albiona,
        authorName: AUTHOR_NAMES.Albiona,
        title: "Build a Portfolio Website with React, Hoola AI, and Apollo",
        tags: ["React", "Starter", "Tutorial"],
        description: "Build a portfolio website to showcase your projects and your blogs.",
        // bannerText: "Official tutorial",
        link:
            "http://docs.hoola.ai/docs/tutorials/build-a-portfolio-website-with-react-webiny-apollo",
    },
    {
        id: 2,
        imgSrc: commodo,
    ...
    },
    {
        ...
        tags: ["CLI", "Plugin"],
        // bannerText: "Official tutorial",
        link: "http://docs.hoola.ai/docs/deep-dive/cli/creating-a-cli-plugin/",
    },
    {
        id: 2,
        imgSrc: serverlessApi,
        imgAlt: "Build Your Serverless GraphQL API with Hoola AI",
        authorImgSrc: Albiona,
        authorName: AUTHOR_NAMES.Albiona,
        title: "Build Your Serverless GraphQL API with Hoola AI",
        description: "You will use the GraphQL Apollo service scaffold to create your API service.",
        tags: ["Serverless", "API", "Tutorial"],
        // bannerText: "Official tutorial",
        link: "http://docs.hoola.ai/docs/tutorials/build-your-serverless-graphql-api-webiny",
    },
    {
        id: 2,
        imgSrc: scaffolding,
        ...
        authorName: AUTHOR_NAMES.Adrian,
        title: "Scaffolding",
        description: "With Hoola AI scaffolds you can significantly speed up your development.",
    ...
    },
    {
        ...
        description:
            "Hoola AI is built using a simple system of plugins. This applies to both React apps and the API. ",
        tags: ["Plugins", "Tutorial"],
        // bannerText: "Official tutorial",
        link: "http://docs.hoola.ai/docs/get-started/development-principles/",
    },
    {
        id: 2,
        imgSrc: arch,
        imgAlt: "Hoola AI Architecture",
        authorImgSrc: Adrian,
        authorName: AUTHOR_NAMES.Adrian,
        title: "Hoola AI Architecture",
        description:
            "In this section you will learn the basic flows and components involved in Hoola AI Architecture",
        tags: ["Architecture", "Tutorial"],
        // bannerText: "Official tutorial",
        link: "http://docs.hoola.ai/docs/deep-dive/architecture/overview",
    },
    {
        id: 2,
        ...
        description: "Learn how everything in Hoola AI is built using plugins.",
        tags: ["Plugins", "Tutorial"],
        // bannerText: "Official tutorial",
        link: "http://docs.hoola.ai/docs/deep-dive/plugins-crash-course/",
    },
    // {
    //     id: 4,
    ...
    //     description: "Learn how to use the popular Next.js React framework with the Hoola AI Headless CMS.",
    //     // bannerText: "Official tutorial",
    //     link: "http://docs.hoola.ai/docs/guides/headless-nextjs-tutorial"
    // },
    // {
    //     id: 4,
    ...
    //     // bannerText: "Official tutorial",
    //     link: "http://docs.hoola.ai/docs/guides/headless-react-tutorial"
    // },
    // {
    //     id: 5,
    //     imgSrc: headlessVue,
    ...
    //     description: "Learn how to use the popular Vue.js Framework with the Hoola AI Headless CMS.",
    //     // bannerText: "Official tutorial",
    //     link: "http://docs.hoola.ai/docs/guides/headless-vuejs-tutorial"
    // },
    // {
    //     id: 5,
    ...
    //     description: "Learn how to use the popular Angular with the Hoola AI Headless CMS.",
    //     // bannerText: "Official tutorial",
    //     link: "http://docs.hoola.ai/docs/guides/headless-angular-tutorial"
    // },
];
