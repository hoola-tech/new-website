    ...
    const accordions = [
        {
            ...
            children: (
                <p>
                    Yes, Hoola AI is completely free to use. Hoola AI is open-sourced under the MIT
                    license.
                </p>
            ),
        },
        ...
        {
            title: "How do I get support for Hoola AI?",
            children: (
                <p>
        ...
        },
        {
            ...
            children: (
                <p>
                    ...
                    , or{" "}
                    <a href="https://site.hoola.ai/forms/product-demo" target="_blank">
                        book a call
                    </a>{" "}
        ...
        },
        {
            ...
            children: (
                <p>
                    Hoola AI Enterprise is designed for organizations which have a long term plan on
                    using, building and delivering solutions on top of Hoola AI.
                    <br />
                    <br />
                    Hoola AI Enterprise offers access to the core Hoola AI team which will help you with
                    project delivery and Hoola AI best-practices.
                    <br />
                    <br />
                    Hoola AI Enterprise ensures long-term product supportability and a safe migration
