...
class Features extends React.Component {
    render() {
        return (
                ...
                <ContentContainer>
                    ...
                    <BoxContainer>
                        <Box>
                            ...
                            <BoxDescription>
                                Hoola AI is built on top of modern serverless technologies, which
                        ...
                        <Box>
                            ...
                            <BoxDescription>
                                ...
                                started with Hoola AI will be a familiar experience from the start.
                            </BoxDescription>
                        </Box>
                        <Box>
            ...
            <BoxFooter>
              <ExternalLink href="#">
                Hoola AI GraphQL Schema Explorer
              </ExternalLink>
            </BoxFooter>
            */}
                        </Box>
                    ...
                    <BoxContainer>
                        <Box>
                            ...
                            <BoxDescription>
                                Hoola AI is not about building just websites. You can build powerful
            ...
            */}
                        ...
                        <Box>
                            ...
                            {/*
            <BoxFooter>
              <ExternalLink href="#">Hoola AI Documentation</ExternalLink>
            </BoxFooter>
             */}
                        </Box>
                        <Box>
                            ...
                            <BoxDescription>
                                ...
                                Hoola AI under the MIT open-source license. Hoola AI will always be and
                                remain FREE.
                            </BoxDescription>
                            {/*
            <BoxFooter>
              <ExternalLink href="#">Hoola AI License</ExternalLink>
            </BoxFooter>
            */}
                        </Box>
                    </BoxContainer>
                    <BoxContainer>
                        <Box>
                            ...
                            <BoxDescription>
                                SSR is included as part of Hoola AI package. Your sites are rendered
            ...
            */}
                        ...
                        <Box>
                            ...
                            <BoxDescription>
                                ...
                                reading and managing your content, Hoola AI is a true headless CMS.
                            </BoxDescription>
                            {/*
            <BoxFooter>
              <ExternalLink href="#">
            ...
            */}
                        ...
                        <Box>
                            ...
                            <BoxDescription>
                                If you are creating content on multiple languages, Hoola AI is a great
            ...
            */}
                    ...
                    <BoxContainer>
                        <Box>
                            ...
                            <BoxDescription>
                                Most visual website builders work with static HTML blocks. Hoola AI is
            ...
            */}
                        ...
                        <Box>
                            ...
                            <BoxDescription>
                                Every website requires a theme. Hoola AI CMS comes with two built-in
            ...
            */}
                    ...
                    <BoxContainer>
                        <Box>
                            ...
                            <BoxDescription>
                                Hoola AI uses a document database. They feature semi-structured
            ...
            */}
                        ...
                        <Box>
                            ...
                            <BoxDescription>
                                Hoola AI is designed as a platform on top of which you can build
          ...
          <Box>
            ...
            <BoxDescription>
              ...
              Hoola AI comes with a built in API and a UI to manage the
          ...
          */}
                        <Box>
                            ...
                            <BoxDescription>
                                Hoola AI provides a simple yet effective security layer. It comprises
