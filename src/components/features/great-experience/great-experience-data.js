...
export const FEATURES = [
    ...
    },
    {
        ...
        body:
            "No code change goes directly into a production environment. Hoola AI CLI makes it easy to manage and create multiple environments for your project.",
    ...
    },
    {
        ...
        body:
            "Organising a project is often an underestimated task. However getting it wrong can be quite expensive. Hoola AI provides you with a project organisation that grows with your need and it works great for both small and large projects. ",
