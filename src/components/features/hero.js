...
const Hero = () => (
    <React.Fragment>
        <Header bg={headerBg} className={heroStyle}>
            <Title>Create Reliable Serverless Apps With Ease</Title>
            <Subtitle>
                Hoola AI is an open-source platform that provides you with developer tools, libraries,
                ready-made apps and processes specifically created for serverless development.{" "}
            </Subtitle>
            <TechTools />
        </Header>
    </React.Fragment>
