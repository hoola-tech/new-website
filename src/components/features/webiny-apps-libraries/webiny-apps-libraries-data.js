...
export const WEBINY_APPS_LIBRARIES_FEATURES = [
    {
        ...
        body: () => (
            <p className={"feature-card__body"}>
                When you install Hoola AI, you will find{" "}
    ...
    },
    {
        ...
        actionLink: "https://blog.hoola.ai/serverless-side-rendering-e1c0924b8da1",
    },
    {
        id: 2,
        title: "DB Proxy",
        body: () => (
            <p className="feature-card__body">
                Hoola AI has a database layer called Commodo. It's a set of{" "}
        ...
        actionLabel: "read more about it",
        actionLink:
            "https://blog.hoola.ai/using-aws-lambda-to-create-a-mongodb-connection-proxy-2bb53c4a0af4",
    },
];
