...
class ContactUs extends React.Component {
    ...
    handleSubmit = event => {
        if (this.state.email !== "" && this.state.name !== "" && this.state.message !== "") {
            ...
            window["$crisp"].push(["do", "message:send", ["text", this.state.message]]);
      ...
      fetch('https://web-api.cloud.hoola.ai/contact-us', {
        method: 'POST',
        headers: {
    ...
    render() {
        return (
            <BoxWrapper>
                ...
                {this.state.submitted && (
                    <Box>
                        Thank you for your message. We will respond at the earliest convenience.
                    </Box>
                )}
            </BoxWrapper>
        );
