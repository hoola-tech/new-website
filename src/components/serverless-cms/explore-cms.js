...
const experienceList = [
    {
        ...
        title: "Scalable",
        body:
            "No matter the demand, Hoola AI Serverless CMS can easily scale to meet even the most challenging workloads.",
        imageSrc: Explore1,
    },
    {
        id: 2,
    ...
    },
    {
        ...
        body: "Hoola AI is self-hosted, it means your data stays within your data center.",
        imageSrc: Explore5,
    },
    {
        id: 6,
    ...
    return (
        <Section>
            <ContentContainer className={overviewContainerClass}>
                <Title>
                    Explore the Benefits of Hoola AI <TitleHighlight>Serverless CMS</TitleHighlight>
                </Title>
                <LogosWrapper>
