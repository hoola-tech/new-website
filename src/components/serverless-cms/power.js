...
const powerList = [
    ...
    },
    {
        title: "Edge network",
        text:
            "Hoola AI deploys a CloudFront CDN in front of the API endpoint for DDoS protection and improved network performance.",
        img: icon8,
    },
    {
        title: "API Editor",
    ...
    return (
        <PowerSection>
            <ContentContainer className={powerContainerClass}>
                <Title>
                    The API that powers Hoola AI <TitleHighlight>Serverless CMS</TitleHighlight>
                </Title>
