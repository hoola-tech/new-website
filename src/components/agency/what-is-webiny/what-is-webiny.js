                ...
                <ContentContainer className={contentContainerClass}>
                    <TextWrapper>
                        ...
                        <Description>
                            ...
                            . It's built on top of AWS cloud and uses the latest technologies such
                            as
                            <HighlightedText> NodeJs, React and GraphQL </HighlightedText>. It's
                            designed for building websites, apps and APIs that
                            <HighlightedText> scale to millions of users</HighlightedText> and run
                            on top of serverless infrastructure like AWS Lambda.
                            <br />
                            With serverless you{" "}
                            <HighlightedText>
                                save 60% on infrastructure cost and even more on infrastructure
