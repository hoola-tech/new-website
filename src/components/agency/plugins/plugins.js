        ...
        return (
            <section {...restProps} className={wrapperClass}>
                <ContentContainer className={contentContainerClass}>
                    <TextWrapper>
                        <Title>Extendable via plugins</Title>
                        <SubTitle>
                            Hoola AI is meant to be extended and customized via plugins. You can
                            easily add your own plugins and integrate with systems like Stripe,
                            Shopify, Mailchimp and others.
                        </SubTitle>
                    </TextWrapper>
                    <Button
