                        ...
                        <BoxWrapper>
                            ...
                            <Box>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <DotImage src={uncheckMark} alt="point" />
                                        Need to over provision and over pay for infrastructure to
                                        handle peak demands
                                    </li>
                                    <li>
                                        <DotImage src={uncheckMark} alt="point" />
                        ...
                        <BoxWrapper>
                            ...
                            <Box>
                                ...
                                <ul>
                                    <li>
                                        <CheckMarkImg src={checkMark} alt="check mark" />
                                        Serverless level scale, handle any peak demand right out of
                                        the box
                                    </li>
                                    <li>
                                        <CheckMarkImg src={checkMark} alt="check mark" />
                                    ...
                                    <li>
                                        <CheckMarkImg src={checkMark} alt="check mark" />
                                        Faster time to market as you don't spend time on
                                        architecting and orchestrating infrastructure
                                    </li>
                                    <li>
                                        <CheckMarkImg src={checkMark} alt="check mark" />
