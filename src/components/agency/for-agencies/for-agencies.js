        ...
        return (
            <section {...this.props} className={wrapperClass}>
                <ContentContainer className={contentContainerClass}>
                    <TextWrapper>
                        <Title>It's a safe bet to try Hoola AI</Title>
                        <SubTitle>
                            Hoola AI is 100% free and open-source and on top of that, our dev team is
                            on standby to help your in-house team learn and adopt Hoola AI - all free
                            of cost. We want you to give Hoola AI a try on a project and let us know
                            your feedback and how we can make it better for the whole community.
                        </SubTitle>
                        <SubText>For you as a web agency Hoola AI solves:</SubText>
                        <SolutionsWrapper>
                            <SolutionCard>
                        ...
                        <SubText size={28}>
                            ...
                            <HighlightedBg>serverless and Hoola AI.</HighlightedBg> Make your
