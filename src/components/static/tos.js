        ...
        <div className="my-8 justify-center px-6 text-justify mx-auto max-w-7xl space-y-8 text-gray-600">
            ...
            <div style={{ textAlign: "left" }}>
                ...
                >
                    <span style={{ fontSize: "11pt", lineHeight: "115%" }}>
                        ...
                        <span className="question">Hoola</span>
                            ...
                            <span style={{ fontSize: "11pt", lineHeight: "115%" }}>
                                <span style={{ fontSize: "11pt", lineHeight: "115%" }}>
                                    ...
                                    <span style={{ fontSize: 15 }}>
                                        <span data-custom-class="body_text">
                                            <span style={{ fontSize: 15 }}>
                                                <span data-custom-class="body_text">
                                                    ...
                                                    , <span className="question">London</span>
                                                </span>
                                            </span>
                                            <span style={{ fontSize: 15 }}>
                                                <span data-custom-class="body_text">
                                            ...
                                            <span style={{ fontSize: "11pt", lineHeight: "115%" }}>
                                                <span
                                                    style={{ fontSize: "11pt", lineHeight: "115%" }}
                                                >
                                                    <span className="else-block" />
                                                </span>
                                            </span>
                                        ...
                                        <span className="question">GB351818985.</span>
                                        <span className="statement-end-if-in-editor" />
                                    </span>
                                </span>
                            </span>
            ...
            <div style={{ textAlign: "left" }}>
                <div data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
                    <span style={{ fontSize: "11pt", lineHeight: "115%" }}>
                        ...
                        <span className="block-component" />, as well as any other related products
                ...
                >
                    <span className="question">
                        We provide an AI platform that you can use to search and translate
                ...
                >
                    <span style={{ fontSize: "11pt", lineHeight: "115%" }}>
                        ...
                        <span className="block-component">
                            email at <span className="question">hello@hoola.ai</span>
                            <span className="block-component" /> or by mail to{" "}
                            <span className="question">128 City Road </span>
                            <span className="block-component" />,{" "}
                            <span className="question">London</span>
                            <span className="block-component" />
                            <span className="block-component" />{" "}
                            <span className="question">EC1V 2NX</span>
                            <span className="statement-end-if-in-editor" />
                            <span className="block-component">, </span>
                            <span className="question">England</span>
                            <span className="statement-end-if-in-editor" />.
                        </span>
                    </span>
                </div>
                ...
                >
                    <span style={{ fontSize: "11pt", lineHeight: "115%" }}>
                        ...
                        ), and <span className="question">Hoola Technology Limited</span>,
                ...
                >
                    <span style={{ fontSize: "11pt", lineHeight: "115%" }}>
                        ...
                        posting or notifying you by <span className="question">hello@hoola.ai</span>
            ...
            <div style={{ textAlign: "left" }}>
                ...
                <div
                    ...
                    style={{ lineHeight: "1.5" }}
                >
                    <span style={{ fontSize: "11pt", lineHeight: "115%", fontFamily: "Arial" }}>
                        ...
                        Services (collectively, the <span className="block-component" />
                        'Content'
                        <span className="else-block" />
                ...
                >
                    <span style={{ fontSize: "11pt", lineHeight: "115%" }}>
                        ...
                        <span className="else-block" /> only.
                    </span>
                </div>
                <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
                    <br />
                ...
                >
                    <span style={{ fontSize: 15 }}>
                        ...
                        <span className="block-component" />'<span className="else-block" />
                    </span>
                    <a data-custom-class="link" href="#prohibited">
                        <span style={{ fontSize: 15 }}>PROHIBITED ACTIVITIES</span>
                    </a>
                    <span style={{ fontSize: 15 }}>
                        <span className="block-component" />'<span className="else-block" /> section
                ...
                >
                    <span style={{ fontSize: "11pt", lineHeight: "115%" }}>
                        ...
                        request to: <span className="question">hello@hoola.ai</span>. If we ever
                        grant you the permission to post, reproduce, or publicly display any part of
                        our Services or Content, you must identify us as the owners or licensors of
            ...
            <div style={{ textAlign: "left" }}>
                ...
                >
                    <span style={{ fontSize: 15 }}>
                        ...
                        Submission. You agree that we shall own this Submission and be entitled to
                ...
                >
                    <span style={{ fontSize: 15 }}>
                        <strong>
                            ...
                            <span className="block-component" />
                            licence
                            <span className="else-block" /> (including use of your name, trademarks,
                            and logos):{" "}
                        </strong>
                        ...
                        licence
                        <span className="else-block" /> to: use, copy, reproduce, distribute, sell,
                        ...
                        and to <span className="block-component" />
                        sublicence the licences
                        <span className="else-block" /> granted in this section. Our use and
                ...
                >
                    <span style={{ fontSize: 15 }}>
                        ...
                        licence
                        <span className="else-block" /> includes our use of your name, company name,
                ...
                <ul>
                    ...
                    >
                        ...
                        <span style={{ fontSize: 15 }}>
                            <span className="block-component" />'<span className="else-block" /> and
                    ...
                    >
                        <span style={{ fontSize: 15 }}>
                            ...
                            <span className="block-component" />
                            licences
                            <span className="else-block" /> to submit such Submissions
                            <span className="block-component" /> and/or Contributions
            ...
            <div style={{ textAlign: "left" }}>
                ...
                >
                    ...
                    <span style={{ fontSize: 15, lineHeight: "115%", color: "rgb(89, 89, 89)" }}>
                        in <span className="question">GB pounds sterling</span>.
                    </span>
                </div>
            </div>
            <div style={{ lineHeight: "1.5" }}>
            ...
            <div style={{ textAlign: "left" }}>
                ...
                >
                    <span style={{ fontSize: "11pt", lineHeight: "115%" }}>
                        ...
                        and any applicable shipping fees, and you{" "}
                        <span className="block-component" />
                        authorise
                        <span className="else-block" /> us to charge your chosen payment provider
            ...
            <div style={{ textAlign: "left" }}>
                ...
                >
                    <span style={{ fontSize: "11pt", lineHeight: "115%" }}>
                        ...
                        <span className="block-component" />
                        judgement
                        <span className="else-block" />, appear to be placed by dealers, resellers,
                        or distributors.
                    </span>
                ...
                >
                    <span style={{ fontSize: 15 }}>
                        ...
                        <span className="block-component" />
                        cancelled
                        <span className="else-block" />. You consent to our charging your payment
                        ...
                        <span className="block-component" /> The length of your billing cycle{" "}
                        <span className="block-component" />
                        is monthly
                        <span className="block-component" />.
                        <span className="statement-end-if-in-editor" />
                ...
                >
                    <span style={{ fontSize: 15 }}>
                        We offer a <span className="question">7</span>-day free trial to new users
                        who register with the Services. <span className="block-component" />
                        <span className="question">
                            The account will not be charged and the subscription will be suspended
                            until upgraded to a paid version
                        </span>{" "}
                ...
                >
                    ...
                    <span className="block-component" /> Your cancellation will take effect at the
                    end of the current paid term. If you have any questions or are unsatisfied with
                    our Services, please email us at{" "}
                    <span className="question">hello@hoola.ai</span>.
                    <span className="statement-end-if-in-editor" />
                    <br />
                </div>
                <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
                                    ...
                                    <span style={{ lineHeight: "115%", fontSize: 19 }}>
                                        <strong>
                                            <span style={{ lineHeight: "115%", fontSize: 19 }}>
                                                <strong>
                                                    <span
                                                        style={{ lineHeight: "115%", fontSize: 19 }}
                                                    >
                                                        7.
                                                    </span>
                                                </strong>
                ...
                <div className="MsoNormal" style={{ textAlign: "justify", lineHeight: 1 }}>
                    ...
                    >
                        ...
                        >
                            ...
                            endeavours
                            <span className="else-block" /> except those that are specifically
                                ...
                                <span style={{ color: "rgb(89, 89, 89)" }}>
                                    <span style={{ fontSize: 14 }}>
                                        <span data-custom-class="body_text">
                                            ...
                                            <span className="block-component" />
                                            licences
                                            <span className="else-block" />, rights, consents,
                                            releases, and permissions to use and to{" "}
                                            <span className="block-component" />
                                            authorise
                                            <span className="else-block" /> us, the Services, and
                                ...
                                <span style={{ color: "rgb(89, 89, 89)" }}>
                                    <span style={{ fontSize: 14 }}>
                                        <span data-custom-class="body_text">
                                            ...
                                            <span className="block-component" />
                                            unauthorised
                                            <span className="else-block" /> advertising, promotional
                            ...
                            <span data-type="body">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <span className="block-component" />
                                        licence
                                        <span className="else-block" /> to host, use, copy,
                                        ...
                                        <span className="else-block" /> of the foregoing. The use
                                        and distribution may occur in any media formats and through
                                        any media channels.
                                    </span>
                                </div>
                            </span>
                            ...
                            <span data-type="body">
                                ...
                                >
                                    ...
                                    >
                                        This <span className="block-component" />
                                        licence
                                        <span className="else-block" /> will apply to any form,
                            ...
                            <span data-type="body">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        re-categorise
                                        <span className="else-block" /> any Contributions to place
                                        them in more appropriate locations on the Services; and (3)
                                        to pre-screen or delete any Contributions at any time and
            ...
            <div style={{ textAlign: "left" }}>
                            ...
                            <span data-type="body">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <span className="block-component" />
                                        'Third-Party Account'
                                        <span className="else-block" />) by either: (1) providing
                                        ...
                                        <span className="else-block" />) so that it is available on
                    ...
                    >
                        ...
                        <strong>
                            ...
                            <span>
                                ...
                                >
                                    <a
                                        href="http://www.hoola.ai/privacy"
                                        target="_blank"
                                        data-custom-class="link"
                                    >
                                        http://www.hoola.ai/privacy
                                    </a>
                                </span>
                            </span>
                        </strong>
                        ...
                        hosted in <span className="block-component" />
                        the <span className="question">United Kingdom</span>
                        <span className="block-component" />
                        ...
                        <span className="block-component" />, then through your continued use of the
                        ...
                        <span className="block-component" />, and you expressly consent to have your
                ...
                >
                    ...
                    >
                        ...
                        Services.
                        <span className="block-component" /> We will not be liable to you or any
                ...
                >
                    ...
                    residence. <span className="question">Hoola Technology Limited</span> and
                    yourself both agree to submit to the non-exclusive jurisdiction of the courts of{" "}
                    <span className="question">__________</span>, which means that you may make a
                    claim to defend your consumer protection rights in regards to these Legal Terms
                    in <span className="block-component" />
                    <span className="question">England</span>
                    <span className="else-block" />, or in the EU country in which you reside.
                    <span className="else-block" />
                </div>
                <div className="MsoNormal" style={{ lineHeight: "1.5", textAlign: "left" }}>
                    <br />
                ...
                >
                    <span style={{ fontSize: 15 }}>
                        ...
                        <span className="else-block" />) brought by either you or us (individually,
                        a <span className="block-component" />
                        ...
                        <span className="question">thirty (30)</span> days before initiating
                ...
                >
                    ...
                    shall be <span className="block-component" />
                    <span className="question">London</span>, <span className="block-component" />
                    <span className="question">England</span>
                    <span className="statement-end-if-in-editor" />. The language of the proceedings
                    shall be <span className="question">English</span>. Applicable rules of
                    substantive law shall be the law of <span className="block-component" />
                    <span className="question">England</span>
                    <span className="else-block" />.<span className="else-block" />
                </div>
                <div className="MsoNormal" style={{ lineHeight: "1.5", textAlign: "left" }}>
                    <br />
                </div>
                ...
                >
                    ...
                    <span className="block-component" />
                    utilise
                    <span className="else-block" /> class action procedures; and (c) there is no
                ...
                >
                    ...
                    <span className="block-component" />
                    unauthorised
                    <span className="else-block" /> use; and (c) any claim for injunctive relief. If
                ...
                >
                    <span style={{ fontSize: "11pt", lineHeight: "115%" }}>
                        ...
                        UNAUTHORISED
                        <span className="else-block" /> ACCESS TO OR USE OF OUR SECURE SERVERS
                        ...
                        <span className="block-component" />
                        JUDGEMENT
                        <span className="else-block" /> AND EXERCISE CAUTION WHERE APPROPRIATE.
                    </span>
                </div>
                <div className="MsoNormal" style={{ lineHeight: "1.5", textAlign: "left" }}>
                    <br />
                ...
                >
                    <span style={{ fontSize: "11pt", lineHeight: "115%" }}>
                        ...
                        Terms; (<span style={{ fontSize: "14.6667px" }}>4</span>) any breach of your
                        ...
                        rights; or (<span style={{ fontSize: "14.6667px" }}>6</span>) any overt
                        ...
                        your expense, to assume the exclusive <span className="block-component" />
                        defence
                        <span className="else-block" /> and control of any matter for which you are
                        required to indemnify us, and you agree to cooperate, at your expense, with
                        our <span className="block-component" />
                        defence
                        <span className="else-block" /> of such claims. We will use reasonable
                ...
                >
                    <span style={{ fontSize: "11pt", lineHeight: "115%" }}>
                        ...
                        <span className="block-component" />
                        defences
                        <span className="else-block" /> you may have based on the electronic form of
                ...
                >
                    <span style={{ fontSize: 15 }}>
                        <span style={{ color: "rgb(89, 89, 89)" }}>
                            <span className="question">
                                <strong>Hoola Technology Limited</strong>
                            </span>
                            <strong>
                                <span className="block-component" />
                            </strong>
