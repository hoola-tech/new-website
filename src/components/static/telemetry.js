...
export default ({ children, ...props }) => (
    <Body title={"Telemetry"}>
        <div>
            ...
            <h3>What is it?</h3>
            <p>
                Hoola AI telemetry is a service that collects <Bold>anonymous</Bold> usage
                information.
            </p>
            <p>
                ...
                single purpose - improving Hoola AI as a product for yourself and the wider community.
            </p>
            <h3>What information we collect:</h3>
            <List>
                <dt>
                    1) Number of deployments - each time you invoke the <code>webiny deploy-*</code>{" "}
                    command inside a Hoola AI project folder
                </dt>
                <dd>Why: So we know how actively the Hoola AI library is used.</dd>
                <dt>
                ...
                <dd>Why: So we know how actively the Hoola AI library is used.</dd>
                <dt>4) List of Hoola AI components that were deployed</dt>
                <dd>Why: So we understand which Hoola AI components are used the most.</dd>
                <dt>5) Timestamp</dt>
                <dd>
                    Why: So we can track the trends between when different operations are invoked.
                </dd>
                <dt>6) Current Hoola AI version</dt>
                <dd>
            ...
            <p>
                ...
                .<br />
                This disables tracking across all your Hoola AI projects.
            </p>
            ...
            <p>Please send all your inquiries to privacy@hoola.ai</p>
        </div>
    </Body>
);
