...
class Newsletter extends React.Component {
    ...
    render() {
        return (
            <React.Fragment>
                <Title htmlFor="newsletter_email">Join Our Newsletter</Title>
                <InputWrapper
                ...
                <NlReasons className="webiny-nl-reason-list">
                    ...
                    <NlReason>Contains only Hoola AI relevant content.</NlReason>
                    <NlReason>Your email is not shared with any 3rd parties.</NlReason>
                </NlReasons>
                <Paragraph>Hoola AI Ltd © 2022</Paragraph>
            </React.Fragment>
        );
    }
}
